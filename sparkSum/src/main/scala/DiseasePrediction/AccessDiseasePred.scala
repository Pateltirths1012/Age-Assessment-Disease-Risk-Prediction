...
object AccessDiseasePred extends App {
  ...
  val modelPath = "C:/Users/patel/Desktop/Model_disease_files" // Replace with the path where your model is saved
  ...
  // Show predictions
  testPredictions.select("prediction").show(50)
}
